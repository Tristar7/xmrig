...
// MoneroOcean: CN-GPU self-test uses the single-hash CPU fallback path.
...
// MoneroOcean: Flex/KCN self-test vector validates the explicit Flex finalizer.
const static uint8_t test_output_flex[32] = {
    0xf8, 0x47, 0x2b, 0x7f, 0x06, 0x88, 0x2f, 0x53, 0x85, 0x9f, 0x41, 0xd2, 0x1d, 0xe1, 0x57, 0xd7,
    0x26, 0x83, 0x6f, 0x30, 0xb7, 0xb6, 0xe6, 0x63, 0xe9, 0x42, 0x77, 0xf8, 0xa1, 0xb3, 0x91, 0xc5
};
// End MoneroOcean
#endif
